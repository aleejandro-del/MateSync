...
public class GrupoDomActivity extends AppCompatActivity {
    ...
    private void setupEventListeners() {
        ...
        btUnirseGrupo.setOnClickListener(v -> mostrarDialogoUnirseGrupo());
    }
    ...
    private void crearGrupoDomestico(String nombreGrupo) {
        ...
        conn.registrarGrupoBBDD(grupoID, grupoDom, new AuthCallback() {
            ...
            public void onSuccess() {
                ...
                actualizarUsuarioEnBBDD(grupoID, nombreGrupo);
            }
    ...
    private void actualizarUsuarioEnBBDD(String grupoID, String nombreGrupo) {
