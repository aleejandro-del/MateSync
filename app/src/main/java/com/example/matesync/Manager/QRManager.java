...
/**
 * Gestor de códigos QR - Módulo transversal
 * Funcionalidades: Generar QR desde texto, leer QR desde Bitmap
 * Uso: Manejo de invitaciones a grupos mediante códigos QR
 */
public class QRManager {
     ...
     * @param texto Texto a codificar (código de invitación)
     * @param ancho Ancho del QR (opcional, por defecto 400)
     * @param alto Alto del QR (opcional, por defecto 400)
