...
public class ConexionBBDD {
    ...
    public void borrarTarea(Tarea tarea, Context context, TareaCallback callback) {
        db.collection("gruposDomesticos").document(tarea.getGrupoID())
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    callback.onSuccessRegisteringTarea(); // Reutilizamos el callback de éxito
                })
                .addOnFailureListener(e -> {
                    Log.e("Firestore", "Error al borrar tarea", e);
                    Toast.makeText(context, "Error al eliminar tarea: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    callback.onFailure(e);
                });
    }

    // Método para borrar un producto
    public void borrarProducto(Producto producto, Context context, ProductoCallback callback) {
        db.collection("gruposDomesticos").document(producto.getGrupoID())
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    Toast.makeText(context, "Producto eliminado de la lista", Toast.LENGTH_SHORT).show();
                    callback.onSuccessRegisteringProducto(); // Reutilizamos el callback de éxito
                })
                .addOnFailureListener(e -> {
                    Log.e("Firestore", "Error al borrar producto", e);
                    Toast.makeText(context, "Error al eliminar producto: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    callback.onFailure(e);
                });
    }

    // Método para borrar un movimiento económico
    public void borrarMovimientoEconomico(MovimientoEconomico movimientoEconomico, Context context, MovEcoCallback callback) {
        db.collection("gruposDomesticos").document(movimientoEconomico.getGrupoID())
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    Toast.makeText(context, "Movimiento económico eliminado", Toast.LENGTH_SHORT).show();
                    callback.onSuccessRegisteringMovimiento(); // Reutilizamos el callback de éxito
                })
                .addOnFailureListener(e -> {
